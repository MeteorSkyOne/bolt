...
echo "gRPC代码生成完成！"
echo "生成的文件："
echo "  proto/coordinator/coordinator.pb.go"
echo "  proto/coordinator/coordinator_grpc.pb.go" 
echo "  proto/server/server.pb.go"
echo "  proto/server/server_grpc.pb.go" 